...
import LoginPromoSideBar from "@/app/auth/login/login-promo-side-bar";
...
const LoginPage = () => {
  ...
  return (
    <div className="w-full flex flex-wrap justify-center gap-6 mt-20">
            ...
            <>
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  <p className="text-sm text-muted-foreground font-bold">{state.email}</p>
      ...
      {!state.success && <LoginPromoSideBar />}
    </div>
  );
};
